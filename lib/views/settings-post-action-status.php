...
<div id="<?php echo esc_attr( $this->base->plugin->name ); ?>-status-form-container" class="hidden">
	<div id="<?php echo esc_attr( $this->base->plugin->name ); ?>-status-form" class="wp-to-social-pro-status-form">
		<div class="notice-inline notice-warning pinterest hidden full">
			<p>
				<?php
				esc_html_e( 'You need to create at least one Pinterest Board, and then refresh the screen to choose the board to post this status to.', 'postiz-auto-poster' );
				?>
				<a href="<?php echo esc_attr( $this->base->plugin->documentation_url ); ?>/status-settings/#buffer-pinterest" target="_blank">
					<?php echo esc_html_e( 'Click here for instructions on creating a Pinterest board.', 'postiz-auto-poster' ); ?>
				</a>
			</p>
		</div>
		...
		<div class="wpzinc-option status">
			<div class="full">
				<h3><?php esc_html_e( 'Status Type and Text', 'postiz-auto-poster' ); ?></h3>
				<p class="description">
					<?php esc_html_e( 'The type of status to create and its text.', 'postiz-auto-poster' ); ?>
				</p>
				...
				if ( isset( $post ) && ! empty( $post ) ) {
					...
					<small class="characters">
						...
						<?php esc_html_e( 'characters', 'postiz-auto-poster' ); ?>
					</small>
					<?php
				}
				?>
		...
		<div class="wpzinc-option status">
			<div class="full">
				<h3><?php esc_html_e( 'Schedule', 'postiz-auto-poster' ); ?></h3>
				<p class="description">
					<?php esc_html_e( 'When the status should be added to social media.', 'postiz-auto-poster' ); ?>
				</p>
		...
		<div class="wpzinc-option link">
			<div class="full">
				<h3><?php esc_html_e( 'Link', 'postiz-auto-poster' ); ?></h3>
				<p class="description">
					<?php esc_html_e( 'The "primary" URL to use for the link preview / card. Additional links can be included in the status text above.', 'postiz-auto-poster' ); ?>
				</p>
		...
		<div class="wpzinc-option pinterest hidden">
			<div class="full">
				<h3><?php esc_html_e( 'Pinterest', 'postiz-auto-poster' ); ?></h3>
				<p class="description">
					<?php
					esc_html_e( 'Define the Pinterest Board for this status to be sent to.', 'postiz-auto-poster' );
					?>
				</p>
						...
						<tr>
							<td width="20%">
								<label for="<?php echo esc_attr( $this->base->plugin->name ); ?>_pinterest_board">
									<?php esc_html_e( 'Board', 'postiz-auto-poster' ); ?>
								</label>
							</td>
							<td>
								...
								<input type="url" name="<?php echo esc_attr( $this->base->plugin->name ); ?>_pinterest[board]" id="<?php echo esc_attr( $this->base->plugin->name ); ?>_pinterest_board" placeholder="<?php esc_attr_e( 'Pinterest Board URL', 'postiz-auto-poster' ); ?>" class="widefat" />
							</td>
						</tr>
							...
							<tr>
								<td>
									<label for="pinterest_title">
										<?php esc_html_e( 'Pin Title', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
									<input type="text" name="<?php echo esc_attr( $this->base->plugin->name ); ?>_pinterest[title]" id="pinterest_title" placeholder="<?php esc_attr_e( 'Pin Title', 'postiz-auto-poster' ); ?>" class="widefat" />
									<p class="description">
										<?php esc_html_e( 'An optional title. Text Tags are supported.', 'postiz-auto-poster' ); ?>
									</p>
								</td>
							</tr>
							<?php
		...
		if ( $this->base->supports( 'googlebusiness' ) ) {
			...
			<div class="wpzinc-option googlebusiness hidden">
				<div class="full">
					<h3><?php esc_html_e( 'Google Business Profile', 'postiz-auto-poster' ); ?></h3>
					<p class="description">
						<?php
						echo esc_html_e( 'Optional: Define the status type (What\'s New, Offer or Event) and additional structured fields / data.', 'postiz-auto-poster' );
						?>
					</p>
							...
							<tr>
								<td width="20%">
									<label for="googlebusiness_post_type">
										<?php esc_html_e( 'Post Type', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
									<select name="<?php echo esc_attr( $this->base->plugin->name ); ?>_googlebusiness[post_type]" id="googlebusiness_post_type" size="1" class="widefat">
										<option value="whats_new"><?php esc_attr_e( 'What\'s New', 'postiz-auto-poster' ); ?></option>
										<option value="offer"><?php esc_attr_e( 'Offer', 'postiz-auto-poster' ); ?></option>
										<option value="event"><?php esc_attr_e( 'Event', 'postiz-auto-poster' ); ?></option>
									</select>
								</td>
							</tr>
							<tr class="whats_new event">
								<td>
									<label for="googlebusiness_cta">
										<?php esc_html_e( 'Call to Action', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
									<select name="<?php echo esc_attr( $this->base->plugin->name ); ?>_googlebusiness[cta]" id="googlebusiness_cta" size="1" class="widefat">
										<option value="book"><?php esc_attr_e( 'Book', 'postiz-auto-poster' ); ?></option>
										<option value="order"><?php esc_attr_e( 'Order', 'postiz-auto-poster' ); ?></option>
										<option value="shop"><?php esc_attr_e( 'Shop', 'postiz-auto-poster' ); ?></option>
										<option value="learn_more"><?php esc_attr_e( 'Learn More', 'postiz-auto-poster' ); ?></option>
										<option value="signup"><?php esc_attr_e( 'Sign Up', 'postiz-auto-poster' ); ?></option>
									</select>
								</td>
							</tr>
							<tr class="offer event">
								<td>
									<label for="googlebusiness_start_date_option">
										<?php esc_html_e( 'Start Date', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
									...
									<input type="text" name="<?php echo esc_attr( $this->base->plugin->name ); ?>_googlebusiness[start_date]" id="googlebusiness_start_date" placeholder="<?php esc_attr_e( 'Custom Meta Field Name', 'postiz-auto-poster' ); ?>" />
								</td>
							</tr>
							<tr class="offer event">
								<td>
									<label for="googlebusiness_end_date_option">
										<?php esc_html_e( 'End Date', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
									...
									<input type="text" name="<?php echo esc_attr( $this->base->plugin->name ); ?>_googlebusiness[end_date]" id="googlebusiness_end_date" placeholder="<?php esc_attr_e( 'Custom Meta Field Name', 'postiz-auto-poster' ); ?>" />
								</td>
							</tr>
							<tr class="offer event">
								<td>
									<label for="googlebusiness_title">
										<?php esc_html_e( 'Event / Offer Title', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
							...
							<tr class="offer">
								<td>
									<label for="googlebusiness_code">
										<?php esc_html_e( 'Coupon Code', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
							...
							<tr class="offer">
								<td>
									<label for="googlebusiness_terms">
										<?php esc_html_e( 'Terms and Conditions Text', 'postiz-auto-poster' ); ?>
									</label>
								</td>
								<td>
		...
		<div class="wpzinc-option images">
			<div class="full">
				<h3><?php esc_html_e( 'Image', 'postiz-auto-poster' ); ?></h3>
				<p class="description">
					<?php esc_html_e( 'The type of image to use.', 'postiz-auto-poster' ); ?>
				</p>
						...
						<tr>
							<td width="20%">
								<label for="<?php echo esc_attr( $this->base->plugin->name ); ?>_image">
									<?php esc_html_e( 'Image', 'postiz-auto-poster' ); ?>
								</label>
							</td>
							<td>
