...
<div class="postbox">
		...
		<h3>
			...
			echo esc_html(
				...
				/* translators: %1$s: Social Media Service (Facebook, Twitter etc.), %2$s: Social Media Profile Name */
					__( '%1$s: %2$s: Settings', 'social-publisher-for-postiz' ),
	...
	<div class="wpzinc-option">        
		<div class="left">
			<label for="<?php echo esc_attr( $profile_id ); ?>_enabled"><?php esc_html_e( 'Account Enabled', 'social-publisher-for-postiz' ); ?></label>
		</div>
		<div class="right">
			...
			<p class="description"><?php esc_html_e( 'Enabling this social media account means that Posts will be sent to this social media account.', 'social-publisher-for-postiz' ); ?></p>
		</div>
	</div>
</div>
