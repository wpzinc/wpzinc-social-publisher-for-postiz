...
class WP_To_Social_Pro_Log_Table extends WP_List_Table {
	...
	protected function bulk_actions( $which = '' ) {
		...
		<label for="bulk-action-selector-<?php echo esc_attr( $which ); ?>" class="screen-reader-text">
			<?php esc_html_e( 'Select bulk action', 'wpzinc-social-publisher-for-postiz' ); ?>
		</label>
		<select name="<?php echo esc_attr( $bulk_actions_name ); ?>" id="bulk-action-selector-<?php echo esc_attr( $which ); ?>" size="1">
			<option value="-1"><?php esc_attr_e( 'Bulk Actions', 'wpzinc-social-publisher-for-postiz' ); ?></option>
		...
		if ( $which === 'top' ) {
			...
			<select name="action" size="1">
				<option value=""<?php selected( $this->get_action(), '' ); ?>><?php esc_attr_e( 'Filter by Action', 'wpzinc-social-publisher-for-postiz' ); ?></option>
				<?php
			...
			<select name="result" size="1">
				<option value=""<?php selected( $this->get_result(), '' ); ?>><?php esc_attr_e( 'Filter by Result', 'wpzinc-social-publisher-for-postiz' ); ?></option>
				<?php
		...
		submit_button( __( 'Apply', 'wpzinc-social-publisher-for-postiz' ), 'action', '', false, array( 'id' => 'doaction' ) );
		...
		<a href="<?php echo esc_url( $clear_logs_url ); ?>" class="<?php echo esc_attr( $this->base->plugin->name ); ?>-clear-log button wpzinc-button-red" data-message="<?php esc_html_e( 'Are you sure you want to clear ALL logs?', 'wpzinc-social-publisher-for-postiz' ); ?>">
	...
	public function no_items() {
		...
		esc_html_e( 'No log entries found based on the given search and filter criteria.', 'wpzinc-social-publisher-for-postiz' );
	...
	public function search_box( $text, $input_id ) {
		...
		<p class="search-box">
			...
			<input type="search" id="<?php echo esc_attr( $input_id ); ?>" name="s" value="<?php _admin_search_query(); ?>" placeholder="<?php esc_attr_e( 'Post ID or Title', 'wpzinc-social-publisher-for-postiz' ); ?>" />
	...
	public function get_columns() {
		...
		return array(
			...
			'post_id'           => __( 'Post ID', 'wpzinc-social-publisher-for-postiz' ),
			'request_sent'      => __( 'Request Sent', 'wpzinc-social-publisher-for-postiz' ),
			'action'            => __( 'Action', 'wpzinc-social-publisher-for-postiz' ),
			'profile_name'      => __( 'Profile', 'wpzinc-social-publisher-for-postiz' ),
			'status_text'       => __( 'Status Text', 'wpzinc-social-publisher-for-postiz' ),
			'result'            => __( 'Result', 'wpzinc-social-publisher-for-postiz' ),
			'result_message'    => __( 'Response', 'wpzinc-social-publisher-for-postiz' ),
	...
	public function get_bulk_actions() {
		...
		return array(
			'delete' => __( 'Delete', 'wpzinc-social-publisher-for-postiz' ),
		);
