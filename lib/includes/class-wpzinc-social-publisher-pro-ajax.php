...
class WPZinc_Social_Publisher_Pro_Ajax {
	...
	public function username_save_twitter() {
		...
		if ( ! isset( $_REQUEST['user_id'] ) ) {
			wp_send_json_error( __( 'No user ID was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
		if ( ! isset( $_REQUEST['username'] ) ) {
			wp_send_json_error( __( 'No username was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
	...
	public function save_statuses() {
		...
		if ( ! isset( $_REQUEST['post_type'] ) ) {
			wp_send_json_error( __( 'No post type was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
		if ( ! isset( $_REQUEST['statuses'] ) ) {
			wp_send_json_error( __( 'No statuses were provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
		...
		if ( ! is_array( $statuses ) ) {
			wp_send_json_error( __( 'Statuses field is invalid.', 'wpzinc-social-publisher-for-postiz' ) );
		}
	...
	public function get_status_row() {
		...
		if ( ! isset( $_REQUEST['status'] ) ) {
			wp_send_json_error( __( 'No status was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
		if ( ! isset( $_REQUEST['post_type'] ) ) {
			wp_send_json_error( __( 'No post type was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
		if ( ! isset( $_REQUEST['post_action'] ) ) {
			wp_send_json_error( __( 'No post action was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
		...
		if ( ! is_array( $status ) ) {
			wp_send_json_error( __( 'Status field is invalid.', 'wpzinc-social-publisher-for-postiz' ) );
		}
	...
	public function get_log() {
		...
		if ( ! isset( $_REQUEST['post'] ) ) {
			wp_send_json_error( __( 'No post ID was provided.', 'wpzinc-social-publisher-for-postiz' ) );
		}
