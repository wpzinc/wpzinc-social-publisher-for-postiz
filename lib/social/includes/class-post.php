				...
				<p>
					...
					echo esc_html(
						...
						/* translators: %1$s: Plugin Name, %2$s: Social Media Service Name (Buffer, Hootsuite) */
							__( '%1$s: Post successfully added to %2$s.', 'wpzinc-social-publisher-for-postiz' ),
			...
			<div class="notice notice-error is-dismissible">
				<p>
					...
					echo esc_html(
						sprintf(
						/* translators: %1$s: Plugin Name, %2$s: Social Media Service Name (Buffer, Hootsuite) */
							__( '%1$s: Some status(es) could not be sent to %2$s', 'wpzinc-social-publisher-for-postiz' ),
							$this->base->plugin->displayName,
							$this->base->plugin->account
						)
					);
