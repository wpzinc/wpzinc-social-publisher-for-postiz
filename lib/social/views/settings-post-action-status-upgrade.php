		...
		<h4>
			...
			echo esc_html(
				...
				/* translators: Social Media Service Name (Buffer, Hootsuite) */
					__( 'Want to %1$s multiple status updates to %2$s?', 'wpzinc-social-publisher-for-postiz' ),
					$post_action,
		...
		<p>
			...
			echo esc_html(
				...
				/* translators: Plugin Name */
					__( 'Define additional unique statuses, each with publishing conditions and custom scheduling, per social network with %s.', 'wpzinc-social-publisher-for-postiz' ),
					$this->base->plugin->displayName
				)
			);
			?>
