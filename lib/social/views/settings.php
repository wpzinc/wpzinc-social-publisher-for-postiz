				...
				<div id="postbox-container-1" class="postbox-container">
					...
					foreach ( $accounts as $account ) {
						if ( $account['plan'] === 'free' ) {
							$upgrade_title       = esc_html__( 'Switch to Social Post Flow', 'wpzinc-social-publisher-for-postiz' );
							$upgrade_content     = esc_html__( 'Up to 5 channels for $49/year. Our own scheduling tool replaces Buffer entirely. The same 5 channels on Buffer\'s paid plan would cost around $360/year, so you save over $300 a year and remove the per channel fee for good.', 'wpzinc-social-publisher-for-postiz' );
							$upgrade_url         = 'https://www.socialpostflow.com/?utm_source=wp-to-buffer&utm_medium=settings&utm_campaign=sidebar-upgrade';
							$upgrade_button_text = esc_html__( 'Try Social Post Flow', 'wpzinc-social-publisher-for-postiz' );
							break;
						}
					}
