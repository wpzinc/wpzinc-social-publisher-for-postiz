...
<div class="postbox">
		...
		<h3>
			...
			echo esc_html(
				...
				/* translators: %1$s: Social Media Service (Facebook, Twitter etc.), %2$s: Social Media Profile Name */
					__( '%1$s: %2$s: Settings', 'wpzinc-social-publisher-for-postiz' ),
	...
	if ( ( class_exists( 'WP_To_Buffer' ) || class_exists( 'WP_To_Hootsuite' ) ) &&
		...
		<div class="wpzinc-option">        
			<div class="left">
				<label for="<?php echo esc_attr( $profile_id ); ?>_enabled"><?php esc_html_e( 'Account Enabled', 'wpzinc-social-publisher-for-postiz' ); ?></label>
			</div>
			<div class="right">
				...
				<p class="description"><?php esc_html_e( 'Enabling this social media account means that Posts will be sent to this social media account.', 'wpzinc-social-publisher-for-postiz' ); ?></p>
			</div>
		</div>
		<?php
		// Upgrade Notice.
